...
for (var i = 0; i < rwsFimsV.length; i++) {
	...
	//process date
	var iPYr = parseInt(fimV.transaction_date.substr(0, 4)); //20170727
	var iPMth = parseInt(fimV.transaction_date.substr(4, 2)); //20170727
	var iPDay = parseInt(fimV.transaction_date.substr(6, 2)); //20170727
